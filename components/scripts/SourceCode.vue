...
.source-code
  .bg
    h2.my-2 Source code
    details
      summary(@click="getCode")
        span.title show source&nbsp;code
      code(v-if="highlightedCode" v-html="highlightedCode")
      div.flex.justify-center(v-else)
        .loader
    span.tip automatically pulls the latest version from my GitHub repository <br/><br/>
  a.red-button.home-page.mx-auto(:href="`https://github.com/dudintv/vizartist-scripts/tree/master/${script.path}`" target="_blank")
