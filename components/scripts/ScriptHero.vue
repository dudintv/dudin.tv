...
.script-hero
  ...
  .content
    .scripts-and-category
      ...
      span.category(:style="{color: gradColorBegin}") {{ script.category }}
    .title.flex
    ...
    .buttons
      a.red-button.home-page(:href="`https://github.com/dudintv/vizartist-scripts/tree/master/${script.path}`" target="_blank")
